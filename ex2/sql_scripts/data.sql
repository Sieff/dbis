...
VALUES (4, 'Hamburg', '20251', 'Reeperbahn', '111', 54.43, 0, 2, 4, 200000.34, false);
INSERT INTO
    house(id, city, postal_code, street, street_nr, square_area, agent_id, seller_id, floors, price, garden)
...
INSERT INTO
    tenancy_contract(contract_number, date, place, start_date, duration_months, additional_costs)
VALUES (1, TO_DATE('17/12/2015', 'DD/MM/YYYY'), 'Hamburg', TO_DATE('17/12/2016', 'DD/MM/YYYY'), 12, 0);

INSERT INTO
    purchase_contract(contract_number, date, place, number_of_installments, interest_rate)
VALUES (2, to_date('13/04/2022', 'DD/MM/YYYY'), 'New York', 80, 1.5);

INSERT INTO
    rent(contract_number, renter_id, apartment_id)
VALUES (1, 1, 2);

INSERT INTO
    sell(contract_number, buyer_id, house_id)
VALUES (2, 3, 6);